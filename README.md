    ...
    <div class="main" id="main">
        ...
        <div class="grid">
            ...
            <div class="card" id="reasonsBtn" role="button" tabindex="0">
                ...
                <h3>100 Reasons</h3>
                <p>Find a reason why I love you — random each click</p>
            </div>
        </div>
...
Keep shining, my babycakes, and remember I’m always here, cheering you on and loving you endlessly.`,
...
I can see how tired you are, and I just want to tell you it’s okay to pause and rest.
You do so much, and sometimes it’s easy to forget that even superheroes need their moments to recharge.
Lay down, close your eyes, and let yourself be gentle today.
I’ll be here when you wake, to hold you, to make you smile, and to remind you that your effort is always appreciated and loved.`,

        angry: `Hi Baby,

It’s okay to feel angry sometimes. Your feelings are valid, and I respect them.
Take your time, breathe deeply, and don’t feel pressured to fix everything at once.
I want you to know that I’m here to listen, to understand, and to support you.
...
Even though we’re apart right now, I feel you close in my heart every single moment.
I replay our laughter, our silly talks, our quiet moments, and it makes me ache in the sweetest way for you.
Hold on to my love, baby, because soon we’ll be together, and all these moments apart will turn into warm hugs and endless smiles.
...
Let’s breathe, let’s talk, and let’s remember why we love each other so much.
I promise, no matter what, I am yours and you are mine. Forever.`
    ...
    function showLetter(mood){
        ...
        container.textContent = moodLetters[mood] || "I love you, always 💖";
    }
</script>
        ...
        <div style="display:flex;gap:12px;margin-top:10px;flex-wrap:wrap;align-items:center">
            ...
            <div style="flex:1;min-width:220px">
                <p class="small">Click "New reason" to show how much I love you in so many beautiful ways, babi.
                    If ga wander ka or ga overthink how much I love you, then here babi. I love you, always, in ways you feel and in ways you haven’t even imagined yet. </p>
            </div>
        </div>
    </div>
</div>
...
<script>
  ...
  "love every little thing about you."
    ...
    function preload(){
      ...
      document.getElementById('reasonBox').textContent = 'Preloaded ' + activeReasons.length + ' reasons — click "New reason"';
    }
